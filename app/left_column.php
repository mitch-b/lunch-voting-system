<div id="left_column">
	<a href="http://www.mitchbarry.com/"><img src="./assets/images/header_logo.gif" alt="mitchbarry.com" class="right_align" /></a><div id="leftspacer"></div>
    <a href="http://www.mitchbarry.com/index.php" class="right_align">home</a><br />
    ...
    <?php 
		...
		{
	?>
    <a href="http://www.mitchbarry.com/cms/" class="right_align">login/register</a>
    <?php
		} else { 
	?>
    <a href="http://www.mitchbarry.com/cms/" class="right_align">cpanel</a><br />
    <a href="http://www.mitchbarry.com/cms/logout.php" class="right_align">logout</a>
    <?php
		}
	?><br /><br />
