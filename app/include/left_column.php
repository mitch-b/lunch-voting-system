...
<div id="left_column">
  <a href="<?= $hostname; ?>"><img src="./assets/images/header_logo.gif" alt="mitchbarry.com" class="right_align" /></a>
  <div id="leftspacer"></div>
  <a href="<?= $hostname; ?>/index.php" class="right_align">home</a><br />
  ...
  ?>
    <a href="<?= $hostname; ?>/cms/" class="right_align">login/register</a>
  <?php
  } else {
  ?>
    <a href="<?= $hostname; ?>/cms/" class="right_align">cpanel</a><br />
    <a href="<?= $hostname; ?>/cms/logout.php" class="right_align">logout</a>
  <?php
  }
  ?><br /><br />
